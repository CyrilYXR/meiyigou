package com.meiyigou.user.service.impl;
...
import com.meiyigou.mapper.TbUserMapper;
import com.meiyigou.pojo.TbUser;
import com.meiyigou.pojo.TbUserExample;
import com.meiyigou.pojo.TbUserExample.Criteria;
...
public class UserServiceImpl implements UserService {
    ...
    public void createSmsCode(final String phone) {
        ...
        //TODO 3.短信内容发送给activeMQ
        jmsTemplate.send(smsDestination, new MessageCreator() {
            @Override
            public Message createMessage(Session session) throws JMSException {
                MapMessage mapMessage = session.createMapMessage();
                mapMessage.setString("mobile", phone);
                mapMessage.setString("template_code","SMS_162197078");//模板编号
                mapMessage.setString("sign_name", "美宜购");//签名
                Map m=new HashMap<>();
